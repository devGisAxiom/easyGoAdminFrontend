...
class _AddBikeDialogState extends State<AddBikeDialog> {
  ...
  if (images != null && images.isNotEmpty) {
    setState(() {
      // Add new images along with already selected ones
  ...
  void _submitBikeData() {
    ...
    AddBike().addBikes(
      ...
      latitude: selectedCurrentLocation!.lLatitude.toString(), 
      longitude:selectedCurrentLocation!.lLongitude.toString()
    );
  }
